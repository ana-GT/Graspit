...
*/
class EigenGraspPlusPlannerDlg : public QDialog, public Ui::EigenGraspPlusPlannerDlgUI
{
	Q_OBJECT
private:
...
public:
 EigenGraspPlusPlannerDlg(QWidget *parent = 0) : QDialog(parent) {
      setupUi(this);
      init();
    }
    ~EigenGraspPlusPlannerDlg(){destroy();}
